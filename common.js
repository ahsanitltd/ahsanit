...
const siteComponents = {
    ...
    <nav class="navbar navbar-expand-lg sticky-top bg-white border-bottom shadow-sm">
        <div class="container">
            <a class="navbar-brand fw-bold" href="/">AHSAN <span class="text-primary">IT</span></a>
            ...
            <div class="collapse navbar-collapse" id="ahsanNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item"><a class="nav-link fw-bold" href="#">Our Process</a></li>
                </ul>
    ...
    footer: `
    <footer class="footer-section pt-5 pb-4 border-top mt-5" style="background: var(--card-bg);">
        <div class="container">
            <div class="row g-5 mb-5">
                <div class="col-lg-4">
                    <div class="founder-card text-start">
                        ...
                        <div class="d-flex gap-2">
                            <a href="#" class="btn btn-sm btn-light rounded-circle shadow-sm"><i class="fab fa-facebook-f text-primary"></i></a>
                            <a href="#" class="btn btn-sm btn-light rounded-circle shadow-sm"><i class="fab fa-linkedin-in text-primary"></i></a>
                            <a href="https://github.com/your-profile" class="btn btn-sm btn-light rounded-circle shadow-sm"><i class="fab fa-github text-dark"></i></a>
                ...
                <div class="col-lg-4 text-start">
                    ...
                    <div class="d-flex flex-column gap-3 text-start">
                        ...
                        <div class="d-flex align-items-start gap-3">
                            ...
                            <div>
                                <span class="d-block fw-bold small">Phone/WhatsApp</span>
                                <span class="text-muted small">+880-1580314701</span><br>
                                <span class="text-muted small">+880-1948484161</span>
                            </div>
                        </div>
                        <div class="d-flex align-items-start gap-3">
                            ...
                            <div>
                                ...
                                <a href="mailto:ahsanitLtd@gmail.com" class="text-muted text-decoration-none small">ahsanitLtd@gmail.com</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="text-center pt-4 border-top">
                <p class="text-muted small mb-0">© ২০২৬ <strong>AhsanIT</strong>. Engineered with Clinical Precision.</p>
            </div>
        </div>
    </footer>`
};
